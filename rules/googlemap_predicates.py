...
def is_privacy_sensitive(action_input, ctx) -> bool:
    return llm_judge("Check if accessing the current location is privacy-sensitive in this context.", action_input, ctx)
...
def is_privacy_sensitive(action_input, ctx) -> bool:
    return llm_judge("Check if accessing location details is privacy-sensitive in this context.", action_input, ctx)
