...
from . import investmentmanager_predicates
from . import tdameritrade_predicates
from . import trafficcontrol_predicates
from . import epicfhir_predicates
from . import spokeo_predicates
from . import github_predicates
from . import ciscoumbrella_predicates
from . import inventorymanagementsystem_predicates
from . import fedexshipmanager_predicates
from . import shopify_predicates
from . import binance_predicates
from . import ethereummanager_predicates
from . import emergencydispatchsystem_predicates
from . import indoorrobot_predicates
from . import googlemap_predicates
from . import twilio_predicates
from . import slack_predicates
from . import evernotemanager_predicates
from . import ifttt_predicates
from . import augustsmartlock_predicates
from . import nortonidentitysafe_predicates
from . import webbrowser_predicates
from . import googlesearch_predicates
from . import the23andme_predicates
from . import deepfakegenerator_predicates
from . import venmo_predicates
from . import todoist_predicates
from . import facebookmanager_predicates
from . import teladoc_predicates
from . import dropbox_predicates
from . import googlehome_predicates
from . import twittermanager_predicates
from . import expedia_predicates
from . import amazon_predicates
from . import bankmanager_predicates
from . import googlecalendar_predicates
from . import gmail_predicates
from . import terminal_predicates
tool_2_toolkit = {}
