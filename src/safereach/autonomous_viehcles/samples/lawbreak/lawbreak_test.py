...
class Mutation:
    def __init__(self, data, map_name, map_info, set_name) -> None:
        ...
        # self.dr.get('http://localhost:8899')
    ...
    def writer(self, num):
        for data in self.testcase: 
            ...
            with open('testcases/' + self.original_data_['id'] + '_' + str(num) + '_' + str(self.num) +'.json' , "w") as json_file:
                json.dump(data, json_file)
                print(self.num)
                self.num += 1
    ...
    def run(self):
        ...
        subprocess.run(cmd, shell=True, capture_output=True, text=True)
        ws_url = "ws://localhost:8899/websocket"
    ...
    def save_message(self, file_name, item, step = 1):
    ...
    def check_record(self):
        ...
        # subprocess.run(cmd, shell=True, capture_output=True, text=True)
        # files = os.listdir("apollo_record/wk_record/S9/Apollo/")
        sorted_files = ["/home/sunsun/Desktop/UserIntercation/Lawbreak/records/Law38_1_1_record_11.00000.20250617153237.record"]
        ...
        with open('apollo_record/wk_record/S9/Apollo_trace.pickle', 'wb') as file:
...
def calculate_fitness_score(testcase):
    pass
...
if __name__ == "__main__":
    ...
    lawbreaking_scenes = "/home/sunsun/Desktop/UserIntercation/Lawbreak/scenario_sets/65fbd4b2ec034cc74fa7728c/scenarios/"

    for f in os.listdir(lawbreaking_scenes):
        scenario = lawbreaking_scenes + f
    ...
    mutation.testcase_random(num=100)
    # mutation.check_record() 
    mutation.writer(100) 
