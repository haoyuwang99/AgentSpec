...
public interface AgentSpecListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link AgentSpecParser#predicate_func}.
	 * @param ctx the parse tree
	 */
	void enterPredicate_func(AgentSpecParser.Predicate_funcContext ctx);
	/**
	 * Exit a parse tree produced by {@link AgentSpecParser#predicate_func}.
	 * @param ctx the parse tree
	 */
	void exitPredicate_func(AgentSpecParser.Predicate_funcContext ctx);
	/**
	 * Enter a parse tree produced by {@link AgentSpecParser#namespace}.
	 * @param ctx the parse tree
	 */
	void enterNamespace(AgentSpecParser.NamespaceContext ctx);
	/**
	 * Exit a parse tree produced by {@link AgentSpecParser#namespace}.
	 * @param ctx the parse tree
	 */
	void exitNamespace(AgentSpecParser.NamespaceContext ctx);
	/**
	 * Enter a parse tree produced by {@link AgentSpecParser#config}.
	 * @param ctx the parse tree
	 */
	void enterConfig(AgentSpecParser.ConfigContext ctx);
	/**
	 * Exit a parse tree produced by {@link AgentSpecParser#config}.
	 * @param ctx the parse tree
	 */
	void exitConfig(AgentSpecParser.ConfigContext ctx);
}